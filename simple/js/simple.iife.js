...
var bootstrap = (function (exports) {
  ...
  var Event$2 = {
    ...
    KEYDOWN_DISMISS: "keydown.dismiss" + EVENT_KEY$1,
    MOUSEUP_DISMISS: "mouseup.dismiss" + EVENT_KEY$1,
    MOUSEDOWN_DISMISS: "mousedown.dismiss" + EVENT_KEY$1,
  ...
  function () {
    function Modal(element, config) {
      this._config = this._getConfig(config);
      this._element = element;
      this._dialog = SelectorEngine.findOne(Selector$1.DIALOG, element);
      this._backdrop = null;
      this._isShown = false;
    ...
    _proto.show = function show(relatedTarget) {
      ...
      if (this._element.classList.contains(ClassName$1.FADE)) {
        this._isTransitioning = true;
      }

      var showEvent = EventHandler.trigger(this._element, Event$2.SHOW, {
        relatedTarget: relatedTarget
      });
      ...
      EventHandler.on(this._element, Event$2.CLICK_DISMISS, Selector$1.DATA_DISMISS, function (event) {
        return _this.hide(event);
      });
      EventHandler.on(this._dialog, Event$2.MOUSEDOWN_DISMISS, function () {
        EventHandler.one(_this._element, Event$2.MOUSEUP_DISMISS, function (event) {
    ...
    _proto.hide = function hide(event) {
      ...
      var hideEvent = EventHandler.trigger(this._element, Event$2.HIDE);
      ...
      var transition = this._element.classList.contains(ClassName$1.FADE);
      ...
      EventHandler.off(document, Event$2.FOCUSIN);

      this._element.classList.remove(ClassName$1.SHOW);

      EventHandler.off(this._element, Event$2.CLICK_DISMISS);
      EventHandler.off(this._dialog, Event$2.MOUSEDOWN_DISMISS);
    ...
    _proto._showElement = function _showElement(relatedTarget) {
      ...
      if (this._dialog.classList.contains(ClassName$1.SCROLLABLE)) {
        SelectorEngine.findOne(Selector$1.MODAL_BODY, this._dialog).scrollTop = 0;
      } else {
      ...
      var transitionComplete = function transitionComplete() {
        ...
        EventHandler.trigger(_this3._element, Event$2.SHOWN, {
          relatedTarget: relatedTarget
        });
      };
    ...
    _proto._enforceFocus = function _enforceFocus() {
      ...
      EventHandler.off(document, Event$2.FOCUSIN); // guard against infinite focus loop

      EventHandler.on(document, Event$2.FOCUSIN, function (event) {
    ...
    _proto._setEscapeEvent = function _setEscapeEvent() {
      ...
      if (this._isShown && this._config.keyboard) {
        EventHandler.on(this._element, Event$2.KEYDOWN_DISMISS, function (event) {
        ...
        EventHandler.off(this._element, Event$2.KEYDOWN_DISMISS);
      }
    };
    ...
    _proto._setResizeEvent = function _setResizeEvent() {
      ...
      if (this._isShown) {
        EventHandler.on(window, Event$2.RESIZE, function (event) {
          return _this6.handleUpdate(event);
        });
      } else {
        EventHandler.off(window, Event$2.RESIZE);
      }
    };
    ...
    _proto._hideModal = function _hideModal() {
      ...
      this._showBackdrop(function () {
        document.body.classList.remove(ClassName$1.OPEN);

        _this7._resetAdjustments();

        _this7._resetScrollbar();

        EventHandler.trigger(_this7._element, Event$2.HIDDEN);
      });
    };
    ...
    _proto._showBackdrop = function _showBackdrop(callback) {
      ...
      var animate = this._element.classList.contains(ClassName$1.FADE) ? ClassName$1.FADE : '';

      if (this._isShown && this._config.backdrop) {
        this._backdrop = document.createElement('div');
        this._backdrop.className = ClassName$1.BACKDROP;
        ...
        EventHandler.on(this._element, Event$2.CLICK_DISMISS, function (event) {
        ...
        this._backdrop.classList.add(ClassName$1.SHOW);
        ...
        this._backdrop.classList.remove(ClassName$1.SHOW);
    ...
    _proto._setScrollbar = function _setScrollbar() {
      ...
      if (this._isBodyOverflowing) {
        ...
        makeArray(SelectorEngine.find(Selector$1.FIXED_CONTENT)).forEach(function (element) {
        ...
        makeArray(SelectorEngine.find(Selector$1.STICKY_CONTENT)).forEach(function (element) {
      ...
      document.body.classList.add(ClassName$1.OPEN);
    };
    ...
    _proto._getScrollbarWidth = function _getScrollbarWidth() {
      ...
      scrollDiv.className = ClassName$1.SCROLLBAR_MEASURER;
    ...
    Modal._jQueryInterface = function _jQueryInterface(config, relatedTarget) {
      return this.each(function () {
        ...
        var _config = _objectSpread({}, Default$1, Manipulator.getDataAttributes(this), typeof config === 'object' && config ? config : {});
  ...
  EventHandler.on(document, Event$2.CLICK_DATA_API, Selector$1.DATA_TOGGLE, function (event) {
    var _this10 = this;
    ...
    var config = Data.getData(target, DATA_KEY$1) ? 'toggle' : _objectSpread({}, Manipulator.getDataAttributes(target), Manipulator.getDataAttributes(this));

    if (this.tagName === 'A' || this.tagName === 'AREA') {
      event.preventDefault();
    }

    EventHandler.one(target, Event$2.SHOW, function (showEvent) {
      if (showEvent.defaultPrevented) {
        // only register focus restorer if modal will actually get shown
        return;
      }

      EventHandler.one(target, Event$2.HIDDEN, function () {
        if (isVisible(_this10)) {
          _this10.focus();
        }
      });
    });
    var data = Data.getData(target, DATA_KEY$1);
  ...
  var Event$3 = {
    ACTIVATE: "activate" + EVENT_KEY$2,
    SCROLL: "scroll" + EVENT_KEY$2,
  ...
  function () {
    function ScrollSpy(element, config) {
      ...
      this._config = this._getConfig(config);
      this._selector = this._config.target + " " + Selector$2.NAV_LINKS + "," + (this._config.target + " " + Selector$2.LIST_ITEMS + ",") + (this._config.target + " ." + ClassName$2.DROPDOWN_ITEM);
      this._offsets = [];
      this._targets = [];
      this._activeTarget = null;
      this._scrollHeight = 0;
      EventHandler.on(this._scrollElement, Event$3.SCROLL, function (event) {
    ...
    _proto._getConfig = function _getConfig(config) {
      config = _objectSpread({}, Default$2, typeof config === 'object' && config ? config : {});
    ...
    _proto._activate = function _activate(target) {
      ...
      if (link.classList.contains(ClassName$2.DROPDOWN_ITEM)) {
        SelectorEngine.findOne(Selector$2.DROPDOWN_TOGGLE, SelectorEngine.closest(link, Selector$2.DROPDOWN)).classList.add(ClassName$2.ACTIVE);
        link.classList.add(ClassName$2.ACTIVE);
      } else {
        // Set triggered link as active
        link.classList.add(ClassName$2.ACTIVE);
        SelectorEngine.parents(link, Selector$2.NAV_LIST_GROUP).forEach(function (listGroup) {
          // Set triggered links parents as active
          // With both <ul> and <nav> markup a parent is the previous sibling of any nav ancestor
          SelectorEngine.prev(listGroup, Selector$2.NAV_LINKS + ", " + Selector$2.LIST_ITEMS).forEach(function (item) {
            return item.classList.add(ClassName$2.ACTIVE);
          }); // Handle special case when .nav-link is inside .nav-item

          SelectorEngine.prev(listGroup, Selector$2.NAV_ITEMS).forEach(function (navItem) {
            SelectorEngine.children(navItem, Selector$2.NAV_LINKS).forEach(function (item) {
              return item.classList.add(ClassName$2.ACTIVE);
            });
          });
        });
      ...
      EventHandler.trigger(this._scrollElement, Event$3.ACTIVATE, {
    ...
    _proto._clear = function _clear() {
      makeArray(SelectorEngine.find(this._selector)).filter(function (node) {
        return node.classList.contains(ClassName$2.ACTIVE);
      }).forEach(function (node) {
        return node.classList.remove(ClassName$2.ACTIVE);
      });
    } // Static
    ;
  ...
  EventHandler.on(window, Event$3.LOAD_DATA_API, function () {
    makeArray(SelectorEngine.find(Selector$2.DATA_SPY)).forEach(function (spy) {
  ...
  if (typeof jQuery !== 'undefined') {
    ...
    jQuery.fn[NAME$2] = ScrollSpy._jQueryInterface;
    jQuery.fn[NAME$2].Constructor = ScrollSpy;
...
//# sourceMappingURL=simple.iife.js.map
